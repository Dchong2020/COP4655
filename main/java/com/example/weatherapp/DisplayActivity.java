...
public class DisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pressure.setText("Pressure : " + String.valueOf(Math.floor(KtoF(Double.parseDouble(w.getPressure())))) + "hPa");
        humidity.setText("Humidity : " + String.valueOf(Math.floor(KtoF(Double.parseDouble(w.getHumidity())))) + "");
